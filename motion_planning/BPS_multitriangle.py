...
class BPS:
    def __init__(self,  x_range, y_range, num_points, dynamic_pointset, num_objects):
    ...
    def cal_sdf(self):
        ...
        for dynamic_points in dynamic_pointset:
            dynamic_points = dynamic_points.reshape(self.num_objects, 3, 2)
            ...
            all_edges = multi_triangle.reshape(3 * self.num_objects, -1)
            all_edges_endpoints = all_edges.reshape((3 * self.num_objects, 2, 2))
...
# x_range = (-1, 1)
# y_range = (-1, 1)
# save_path = 'data/first_trajectory'
# first_trajectory = np.load('data/T00.npy')
# Generator = BPS(x_range, y_range, num_basispoints, first_trajectory)
# Generator.cal_sdf()
